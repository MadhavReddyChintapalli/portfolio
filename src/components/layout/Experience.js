      ...
      <div className='row'>
        <div className='col-lg-6'>
          ...
          <ul>
            ...
            <li>
              ...
              Axios for data fetching, Redux for state management, React
              Developer Tools for debugging.
            </li>
            <li>
              Performing end-to-end testing on React applications using JEST.
            </li>
            <li>
              Generating Code Coverage Reports for unit tests on web
              applications.
            </li>
            <li>
            ...
            <li>
              Created Restful APIs using Node.js with Express.js, and used
              Postman for testing APIs.
            </li>
            <li>Deployed Web applications on Heroku, Amazon AWS.</li>
            <li>
              Used JIRA for project management and tracking issues, Git for
              version control.
            </li>
          </ul>
          <br />
        ...
        <div className='col-lg-6'>
          ...
          <ul>
            ...
            <li>
              Created Angular Components and Services using Angular CLI,
              followed MVC Framework
            </li>
            <li>Used TypeScript for writing web applications.</li>
            <li>
              Performing Unit testing on components, services, pipes, and
              directives using Karma and Jasmine.
            </li>
            <li>
              Performing End-to-End testing on Angular applications using
            ...
            <li>
              Deployed Web applications on Heroku and Microsoft Azure DevOps.
            </li>
          </ul>
        </div>
      </div>
